...
namespace Escon.SisctNET.Repository.Implementation
{
    public class DarDocumentRepository : Repository<DarDocument>, IDarDocumentRepository
    {
        ...
        public async Task<List<DarDocumentCompany>> FindByPeriodReferenceAsync(int periodReference, long? companyid)
        {
        ...
        public async Task<List<DarDocument>> GetByCompanyIdAsync(long id) =>
            await _context.DarDocuments
            .Include(x => x.Company)
            .Include(x => x.Dar)
