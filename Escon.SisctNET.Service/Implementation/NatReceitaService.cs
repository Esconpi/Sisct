...
namespace Escon.SisctNET.Service.Implementation
{
    public class NatReceitaService : INatReceitaService
    {
        ...
        public List<NatReceita> Create(List<NatReceita> entities, Log log)
        {
        ...
        public void Delete(List<NatReceita> entities, Log log)
        {
        ...
        public List<NatReceita> Update(List<NatReceita> entities, Log log)
        {
