...
namespace Escon.SisctNET.Web.Sped
{
    public class Import
    {
        ...
        public List<decimal> NFeLPresumido(string directorySped, List<string> cfopsDevo, List<string> cfopsDevoST, List<string> cfopsBoniCompra, List<TaxationNcm> taxationNcms, 
                                           Company company)
        {
        ...
        public List<decimal> NFeEntry(string directorySped, List<string> cfopsCompra, List<string> cfopsBonifi, List<string> cfopsCompraST,
                                     List<string> cfopsTransf, List<string> cfopsTransfST, Company company)
        {
        ...
        public List<decimal> NFeLReal(string directorySped, List<string> cfopsCompra, List<string> cfopsBonifi, List<string> cfopsCompraST,
                                      ...
                                      List<TaxationNcm> taxationNcms, Company company)
        {
            List<decimal> entradas = new List<decimal>();
                    ...
                    if (!line.Equals(""))
                    {
                        ...
                        if (linha[1].Equals("0200"))
                        {
                            ...
                            foreach (var note in notes)
                            {
                                ...
                                if (note[1].Equals("C170") && tipo == "0" && emisao == "1")
                                {
                                    if (note[3].Equals(linha[2]))
                                    {
            ...
            try
            {
                while ((line = archiveSped.ReadLine()) != null)
                {
                    if (!line.Equals(""))
                    {
                        ...
                        if (linha[1] == "C100")
                        {
                            if((linha[2] == "1" || (linha[2] == "0" && linha[3] == "0")) && linha[6] != "05" && linha[6] != "03" && linha[6] != "02")
                            {
                                List<string> sped = new List<string>();
                                sped.Add(linha[9]);
                                sped.Add(linha[5]);
