    ...
    public class TaxController : ControllerBaseSisctNET
    {
        ...
        public async Task<IActionResult> Import(string imposto, string type, List<IFormFile> arquivo)
        {
            ...
            try
            {
                ...
                var importXml = new Xml.Import(_cfopService, _taxationNcmService);
                var importSped = new Sped.Import(_cfopService, _taxationNcmService);
                ...
                var cfopsPerda = _cfopService.FindByCfopPerda(cfopAll)
                    .Select(_ => _.Code)
                    .Distinct()
                    .ToList();
                        ...
                        if(comp.Incentive && !comp.TipoApuracao)
                        {
                            ...
                            else if (comp.Annex.Description.Equals("ANEXO CCCXXVI (Art. 791 - A)"))
                            {
                                ...
                                for (int i = exitNotes.Count - 1; i >= 0; i--)
                                {
                                    ...
                                    bool ncm = false, cfop = false, nContribuinte = false;
                                    string CFOP = "";
                                    decimal vProd = 0;

                                    string UF = exitNotes[i][3].ContainsKey("UF") ? exitNotes[i][3]["UF"] : comp.County.State.UF;

                                    if (exitNotes[i][1]["mod"].Equals("65"))
                                    {
                                        string CNPJ = exitNotes[i][3].ContainsKey("CNPJ") ? exitNotes[i][3]["CNPJ"] : "escon";
                                        string CPF = exitNotes[i][3].ContainsKey("CPF") ? exitNotes[i][3]["CPF"] : "escon";

                                        if (CNPJ.Equals("escon") || exitNotes[i][3].ContainsKey("CPF") || CPF.Equals("escon"))
                                        { 
                                            nContribuinte = true;
                                        }
                                    }
                                        ...
                                        if (cfop)
                                        {
                                            if (exitNotes[i][j].ContainsKey("vProd") && exitNotes[i][j].ContainsKey("cProd"))
                                            {
                                                ...
                                                if (ncm)
                                                {
                                                    ...
                                                    {
                                                        totalNcm += Convert.ToDecimal(exitNotes[i][j]["vProd"]);
                                                        totalInterna += Convert.ToDecimal(exitNotes[i][j]["vProd"]);

                                                    }
                                                    else
                                                        totalInter += Convert.ToDecimal(exitNotes[i][j]["vProd"]);
                                                }
                                            }
                                            ...
                                            if (exitNotes[i][j].ContainsKey("vFrete") && exitNotes[i][j].ContainsKey("cProd"))
                                            {
                                                ...
                                                if (ncm)
                                                {
                                                    ...
                                                    {
                                                        totalNcm += Convert.ToDecimal(exitNotes[i][j]["vFrete"]);
                                                        totalInterna += Convert.ToDecimal(exitNotes[i][j]["vFrete"]);
                                                    }
                                                    else
                                                        totalInter += Convert.ToDecimal(exitNotes[i][j]["vFrete"]);
                                                }
                                            }
                                            ...
                                            if (exitNotes[i][j].ContainsKey("vDesc") && exitNotes[i][j].ContainsKey("cProd"))
                                            {
                                                ...
                                                if (ncm)
                                                {
                                                    ...
                                                    {
                                                        totalNcm -= Convert.ToDecimal(exitNotes[i][j]["vDesc"]);
                                                        totalInterna -= Convert.ToDecimal(exitNotes[i][j]["vDesc"]);
                                                    }
                                                    else
                                                        totalInter -= Convert.ToDecimal(exitNotes[i][j]["vDesc"]);
                                                }
                                            }
                                            ...
                                            if (exitNotes[i][j].ContainsKey("vOutro") && exitNotes[i][j].ContainsKey("cProd"))
                                            {
                                                ...
                                                if (ncm)
                                                {
                                                    ...
                                                    {
                                                        totalNcm += Convert.ToDecimal(exitNotes[i][j]["vOutro"]);
                                                        totalInterna += Convert.ToDecimal(exitNotes[i][j]["vOutro"]);
                                                    }
                                                    else
                                                        totalInter += Convert.ToDecimal(exitNotes[i][j]["vOutro"]);
                                                }
                                            }
                                            ...
                                            if (exitNotes[i][j].ContainsKey("vSeg") && exitNotes[i][j].ContainsKey("cProd"))
                                            {
                                                ...
                                                if (ncm)
                                                {
                                                    ...
                                                    {
                                                        totalNcm += Convert.ToDecimal(exitNotes[i][j]["vSeg"]);
                                                        totalInterna += Convert.ToDecimal(exitNotes[i][j]["vSeg"]);
                                                    }
                                                    else
                                                        totalInter += Convert.ToDecimal(exitNotes[i][j]["vSeg"]);
                                                }
                                            }

                                            if (exitNotes[i][j].ContainsKey("pICMS") && exitNotes[i][j].ContainsKey("orig") && exitNotes[i][j].ContainsKey("CST"))
                                            {
                                                string CST = exitNotes[i][j]["CST"];
                                                decimal pICMS = Convert.ToDecimal(exitNotes[i][j]["pICMS"]),
                                                        pRedBC = exitNotes[i][j].ContainsKey("pRedBC") ? Convert.ToDecimal(exitNotes[i][j]["pRedBC"]) : 0;

                                                if (pICMS.Equals(comp.VendaInterna))
                                                {
                                                    if (CFOP == "5102" && CST == "00")
                                                    { 
                                                        if (ncm)
                                            ...
                                            if (exitNotes[i][j].ContainsKey("pICMSST") && exitNotes[i][j].ContainsKey("orig") && exitNotes[i][j].ContainsKey("CST"))
                                            {
                                                string CST = exitNotes[i][j]["CST"];
                                                decimal pICMSST = Convert.ToDecimal(exitNotes[i][j]["pICMSST"]);

                                                if (pICMSST.Equals(comp.VendaInterna))
                                                {
                                                    if (CFOP == "5403" && CST == "30")
                                                    {
                                                        if (ncm)
                                ...
                                if (imp != null)
                                {
                                    ...
                                    imp.VendasInter = totalInter;
                                    imp.IcmsInterna = vICMS;
                                    imp.IcmsSTInterna = vICMSST;
                                    imp.Icms = true;
                                ...
                                else
                                {
                                    ...
                                    tax.VendasInter = totalInter;
                                    tax.IcmsInterna = vICMS;
                                    tax.IcmsSTInterna = vICMSST;
                                    tax.Icms = true;    
                                }
                            }
                        }
                ...
                else if (imposto.Equals("pisCofins"))
                {
                    ...
                    else if (type.Equals("xmlS") || type.Equals("xmlE"))
                    {
                        ...
                        var codeProd1 = ncmsCompany.Where(_ => _.TypeNcm.Name.Equals("Combustível"))
                            .Select(_ => _.CodeProduct)
                            .ToList();
                        var codeProd2 = ncmsCompany.Where(_ => _.TypeNcm.Name.Equals("Comércio"))
                            .Select(_ => _.CodeProduct)
                            .ToList();
                                            ...
                                            if (comp.Taxation == "Produto")
                                            {
                                                if (codeProdAll.Contains(cProd) && ncmAll.Contains(NCM))
                                                {
                                                    var ehMono = ncmsTaxation.Where(_ => _.CodeProduct.Equals(cProd) && _.Ncm.Code.Equals(NCM) &&
                                                                                    (_.TaxationTypeNcm.Description.Equals("Monofásico") || _.TaxationTypeNcm.Description.Equals("Aliquota Zero") ||
                            ...
                            else if (comp.CountingType.Name.Equals("Simples Nacional"))
                            {
                                ...
                                for (int i = exitNotes.Count - 1; i >= 0; i--)
                                {
                                    ...
                                    if (exitNotes[i][1].ContainsKey("dhEmi"))
                                    {
                                        ...
                                        codeProdNormal = ncmsTaxation.Where(_ => _.TaxationTypeNcm.Description.Equals("Normal")).Select(_ => _.CodeProduct).ToList();
                                        codeProdMono = ncmsTaxation.Where(_ => _.TaxationTypeNcm.Description.Equals("Monofásico")).Select(_ => _.CodeProduct).ToList();
                                        codeProdAliqZero = ncmsTaxation.Where(_ => _.TaxationTypeNcm.Description.Equals("Aliquota Zero")).Select(_ => _.CodeProduct).ToList();
                                        codeProdST = ncmsTaxation.Where(_ => _.TaxationTypeNcm.Description.Equals("S. Tributária")).Select(_ => _.CodeProduct).ToList();
                                        codeProdIsento = ncmsTaxation.Where(_ => _.TaxationTypeNcm.Description.Equals("Isento")).Select(_ => _.CodeProduct).ToList();
                                        codeProdOutras = ncmsTaxation.Where(_ => _.TaxationTypeNcm.Description.Equals("Outras")).Select(_ => _.CodeProduct).ToList();

                                        ncmNormal = ncmsTaxation.Where(_ => _.TaxationTypeNcm.Description.Equals("Normal")).Select(_ => _.Ncm.Code).ToList();
                                        ncmMono = ncmsTaxation.Where(_ => _.TaxationTypeNcm.Description.Equals("Monofásico")).Select(_ => _.Ncm.Code).ToList();
                                        ncmAliqZero = ncmsTaxation.Where(_ => _.TaxationTypeNcm.Description.Equals("Aliquota Zero")).Select(_ => _.Ncm.Code).ToList();
                                        ncmST = ncmsTaxation.Where(_ => _.TaxationTypeNcm.Description.Equals("S. Tributária")).Select(_ => _.Ncm.Code).ToList();
                                        ncmIsento = ncmsTaxation.Where(_ => _.TaxationTypeNcm.Description.Equals("Isento")).Select(_ => _.Ncm.Code).ToList();
                                        ncmOutras = ncmsTaxation.Where(_ => _.TaxationTypeNcm.Description.Equals("Outras")).Select(_ => _.Ncm.Code).ToList();
