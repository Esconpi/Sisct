    ...
    public class TaxationNcmController : ControllerBaseSisctNET
    {
        ...
        public IActionResult Atualize(int id, Model.TaxationNcm entity)
        {
            try
            {
                ...
                entity.CstEntradaId = rst.CstEntradaId;
                entity.CstSaidaId = rst.CstSaidaId;
                entity.Status = true;
                entity.NatReceita = rst.NatReceita;
                entity.Pis = rst.Pis;
                entity.Cofins = rst.Cofins;
                entity.DateStart = rst.DateStart;
        ...
        public IActionResult GetAll(int draw, int start)
        {
            ...
            var ncmsAll = _service.FindAll(GetLog(Model.OccorenceLog.Read)).OrderBy(_ => _.Ncm.Code).Where(_ => _.Status.Equals(true)).ToList();
            ...
            if (!string.IsNullOrEmpty(Request.Query["search[value]"]))
            {
                ...
                var ncm = from r in ncms
                          ...
                          select new
                          {
                              ...
                              Fim = Convert.ToDateTime(r.DateEnd).ToString("dd/MM/yyy")
