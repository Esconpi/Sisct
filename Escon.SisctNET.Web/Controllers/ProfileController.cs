...
namespace Escon.SisctNET.Web.Controllers
{
    public class ProfileController : ControllerBaseSisctNET
    {
        ...
        public IActionResult Index()
        {
            ...
            if (SessionManager.GetAccessesInSession() == null || !SessionManager.GetAccessesInSession().Where(_ => _.Functionality.Name.Equals("Profile")).FirstOrDefault().Active)
                return Unauthorized();
        ...
        [HttpPost]
        public IActionResult Edit(long id, Model.Profile entity)
        {
            if (SessionManager.GetAccessesInSession() == null || !SessionManager.GetAccessesInSession().Where(_ => _.Functionality.Name.Equals("Profile")).FirstOrDefault().Active)
                return Unauthorized();
